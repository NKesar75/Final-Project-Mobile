...
public class calender extends AppCompatActivity implements EasyPermissions.PermissionCallbacks {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        callApiBtn = new Button(this);
        callApiBtn.setText("Refresh");
        callApiBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                callApiBtn.setEnabled(false);
                mOutput.setText("");
                getResultsFromApi();
                callApiBtn.setEnabled(true);
            }
        });
        activityLayout.addView(callApiBtn);

        mOutput = new TextView(this);
        mOutput.setLayoutParams(tlp);
        ...
        activityLayout.addView(mOutput);
...
//        startActivity(intent);
    ...
    private void getResultsFromApi() {
        if (! isGooglePlayServicesAvailable()) {
            ...
            mOutput.setText("No network connection available.");
        } else {
    ...
    private class MakeRequestTask extends AsyncTask<Void, Void, List<String>> {
         ...
         * if mLastError equals null register project
         */
        @Override
        ...
        protected void onPostExecute(List<String> output) {
            ...
            if (output == null || output.size() == 0) {
                mOutput.setText("No results returned.");
            } else {
                output.add(0, "Data retrieved using the Google Calendar API:");
                mOutput.setText(TextUtils.join("\n", output));

//                for (int i = 0; i < output.size(); i++) {
//                    String tosplit = output.get(i);
        ...
        protected void onCancelled() {
            ...
            if (mLastError != null) {
                if (mLastError instanceof GooglePlayServicesAvailabilityIOException) {
                    ...
                    mOutput.setText("The following error occurred:\n"
                            + mLastError.getMessage());
                }
            } else {
                mOutput.setText("Request cancelled.");
            }
        }
    }
